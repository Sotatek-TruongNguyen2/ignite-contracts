...
contract Pool is Pausable, ReentrancyGuard, IgnitionList, AccessControl, Initializable {
    ...
    /**
     * @dev Max purchase amount for galaxy pool 
     * = total raise amount * galaxy pool proportion
     */
    uint public maxPurchaseAmountForGalaxyPool;

    /**
     * @dev Max purchase amount for early access 
     * = (total raise amount - total raise amount * galaxy pool proportion) * early access proportion
     */
